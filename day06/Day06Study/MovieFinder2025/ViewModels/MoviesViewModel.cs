...
namespace MovieFinder2025.ViewModels
{
    public partial class MoviesViewModel : ObservableObject
    {
        ...
        {
            //await this.dialogCoordinator.ShowMessageAsync(this, "영화검색", $"{MovieName} 검색합니다.");
        ...
        {
            string tmdb_apikey = "6bd769179a888422fc3f1d8c971639a5"; // TMDB에서 신청한 API키
        ...
        {
            await this.dialogCoordinator.ShowMessageAsync(this, "예고편보기", "즐겨찾기 삭제합니다!");
        }
    }
}
